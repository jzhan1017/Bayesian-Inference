...
/**
 * A CPT is a conditional  table, as stored in a Node of a
 ...
 *  of the query variable value given the values of the
 ...
 * are all Values containing a double value.
 * <p>
...
public class CPT {
	...
	/**
	 * The terminal Entries in a CPT contain the  value
